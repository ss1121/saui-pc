...
(function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        iconsPrefix: 'iconfont', // glyphicon of fa (font awesome)       //  我们现在用的是 iconfont 
        icons: {
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            html.push('</div>',
                ...
                '<li class="page-pre"><a href="#" class="item-icon"></a></li>');
            ...
            html.push(
                ...
                '<li class="page-next"><a href="#" class="item-icon"></a></li>',
                '</ul>',
                '</div>');
        }
